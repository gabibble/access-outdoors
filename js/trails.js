    ...
    cards.innerHTML += `     
      <div class="col-md-4 col-sm-6 mb-4">
            <div class="card" >
              ...
              <div class="card-body">
                <h5 class="card-title">${element.trail}</h5>
                <h6>${element.area}</h6>
                <p class="card-text">${element.city}, ${element.state}</p>
                <a href="/trail.html?ssid=${ssid}&id=${element.id}" class="btn btn-primary" id=${element.id}>Learn More</a>
              </div>
            </div>
          </div>`;
  });
